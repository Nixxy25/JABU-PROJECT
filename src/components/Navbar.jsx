        ...
        <nav className="px-24 py-6 max-sm:p-0">
            ...
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-12 max-lg:hidden">
                    ...
                    <img className="cursor-pointer w-32 border-r border-gray-400" alt="poolot-logo" src="/src/assets/poolot-logo.png"></img>
            ...
            <div className="lg:hidden relative ">
                <div className="flex justify-between px-4">
                    <img className="w-32" src="/src/assets/poolot-logo.png"></img>
