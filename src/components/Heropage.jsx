    ...
    <div>
        <div className="px-24 max-sm:px-4 max-lg:px-10 flex items-center pt-24 gap-8 justify-between bg-[#bae6fd] max-lg:py-36  rounded-xl">
            ...
            <div className="flex flex-col gap-8 w-full">
                ...
                <div className="text-6xl font-bold max-sm:text-4xl max-lg:text-5xl max-lg:w-3/4">Master the Skills Drive Your Career.</div>

                <div className="text-gray-600 max-sm:text-[15.4px] max-lg:w-3/4">Through a combination of lectures, readings, and discussions, students
